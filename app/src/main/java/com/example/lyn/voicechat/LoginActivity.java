...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                attemptLogin();
                Intent i = new Intent(LoginActivity.this, UserOpsActivity.class);
                i.putExtra(UserOpsActivity.EXTRA_GROUPID, mGroupId);
    ...
    public void attemptLogin() {
        ...
        if(!TextUtils.isEmpty(ip) && !isIpValid(ip)){
            mIpView.setError("IP is invalid");
            focusView = mIpView;
            cancel = true;
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String loginUrl = "http://" +  mIp + "/xnode-cu/cu/groupId";
            HttpObj http = new HttpObj(mEmail, mPassword);
            mResult = http.getData(loginUrl);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            try {
                //解析流，设定需要解析的节点
                List<HashMap<String, String>> list=SaxService.readXML(new ByteArrayInputStream(mResult.getBytes()), "groupId");
                for(HashMap<String,String> map:list)
                {
                    //打印到LogCat中
                    System.out.println(map.toString());
                    String groupIdValue = getNumbers(map.toString());
                    Log.e("xmlGroupId", groupIdValue);
                    mGroupId = Integer.parseInt(groupIdValue);
                    System.out.println(mGroupId);
                }
            } catch (Exception e) {
